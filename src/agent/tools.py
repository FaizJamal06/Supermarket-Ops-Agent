"""
Anthropic Tool Registry — maps PRD §4.3 capabilities to Anthropic API tool schemas.
"""
...
GEMINI_TOOLS = [types.Tool(function_declarations=[types.FunctionDeclaration(**t) for t in RAW_SCHEMAS])]
